...
namespace SharedViewModels.ViewModels
{
    public class CreateProjectViewModel : NotifyPropertyChangedBase
    {
        ...
        public List<IdSourceSystem> IdSourceSystems { get; } = EnumExtensions.GetValues<IdSourceSystem>().ToList();
        private IdSourceSystem selectedIdSourceSystem;
        public IdSourceSystem SelectedIdSourceSystem
        {
