...
namespace AutoCompleteMatchers
{
    public class StringAutoCompleteMatcher : IAutoCompleteMatcher<string>
    {
        ...
        public async Task<IEnumerable<string>> FindMatches(IReadonlyObjectDatabase<string> objectDatabase, string searchText, int maxSuggestions)
        {
            return (await objectDatabase.GetAllAsync())
